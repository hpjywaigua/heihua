...
// Function Skill.UTSkillBaseWidget.SetValueAsUInt
// ()
// Parameters:
// struct FUAEBlackboardKeySelector Key                            (ConstParm, Parm, OutParm, ReferenceParm)
// uint32_t                       UIntValue                      (Parm, ZeroConstructor, IsPlainOldData)

void UUTSkillBaseWidget::SetValueAsUInt(const struct FUAEBlackboardKeySelector& Key, uint32_t UIntValue)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Skill.UTSkillBaseWidget.SetValueAsUInt");

	UUTSkillBaseWidget_SetValueAsUInt_Params params;
	params.Key = Key;
...
// Function Skill.UTSkillBaseWidget.GetValueAsUInt
// ()
// Parameters:
// struct FUAEBlackboardKeySelector Key                            (ConstParm, Parm, OutParm, ReferenceParm)
// uint32_t                       ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

uint32_t UUTSkillBaseWidget::GetValueAsUInt(const struct FUAEBlackboardKeySelector& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Skill.UTSkillBaseWidget.GetValueAsUInt");

	UUTSkillBaseWidget_GetValueAsUInt_Params params;
	params.Key = Key;
...
// TArray<struct FUAEBlackboardKeySelector> KeySelectors                   (ConstParm, Parm, ZeroConstructor, ReferenceParm)
...
void UUTSkillManagerComponent::ServerTriggerEvent_WithParamsAndTssData(int SkillID, TEnumAsByte<EUTSkillEventType> EventType, uint64_t InstID, TArray<struct FUAEBlackboardKeySelector> KeySelectors, TArray<unsigned char> Content, TArray<unsigned char> TssData)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
	...
	params.KeySelectors = KeySelectors;
...
void UUTSkillManagerComponent::ServerTriggerEvent_WithParams(int SkillID, TEnumAsByte<EUTSkillEventType> EventType, uint64_t InstID, TArray<struct FUAEBlackboardKeySelector> KeySelectors, TArray<unsigned char> Content)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UUTSkillBlackboardInterface::SetValueAsUInt(int SkillID, const struct FUAEBlackboardKeySelector& Key, uint32_t UIntValue)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
uint32_t UUTSkillBlackboardInterface::GetValueAsUInt(int SkillID, const struct FUAEBlackboardKeySelector& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
class UObject* UUTSkillBlackboardInterface::GetValueAsObject(int SkillID, const struct FUAEBlackboardKeySelector& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
