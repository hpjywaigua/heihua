...
struct UUAETableManager_TriggerReleaseTable_Params
{
};
...
struct UUAETableManager_RegisterMemWarningEvent_Params
{
};

// Function Basic.UAETableManager.LuaReleaseAllTable
struct UUAETableManager_LuaReleaseAllTable_Params
{
};
