...
public:
	...
	void STATIC_SetGrenadeDefaultPickValue();
	...
	void STATIC_GetRankTexture(int rankIntegral, class UTexture2D** Output);
	void STATIC_GetCorpsIconTexture(int IconID, class UTexture2D** Value);
	void STATIC_GetFrameTexture(int frameLevel, class UTexture2D** Output);
	void EventAndroidQuitGame();
	void EnterLogin();
	void RecoverMaxFps();
	void Construct();
	void STATIC_ExecuteUbergraph_Global_Bp(int EntryPoint);
};
