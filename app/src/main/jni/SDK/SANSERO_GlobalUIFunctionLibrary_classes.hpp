...
public:
	...
	void STATIC_ProcessAndroidBack(class UObject* __WorldContext);
	void STATIC_SetSpecialIconWithSprite2DMatchSize(class UImage* Widget, const struct FString& specialIconPath, class UObject* __WorldContext);
	...
	void STATIC_PlaySoundPopup(class UObject* __WorldContext);
	...
	void GetGlobalLuaUI(class UObject* WorldContextObject, class UObject* __WorldContext, class UGlobalLuaWidget_C** AsGlobal_Lua_Widget);
	...
	void SwitchSceneCameraToTransform_2(const struct FTransform& Transform, float FOV, float blendTime, class UObject* __WorldContext);
	void GetVector4(float X, float Y, float W, float H, class UObject* __WorldContext, struct FVector4* Vector);
	void DestroyLobbyCameras(class UObject* __WorldContext);
	...
	void SwitchSceneCameraToTransform(const struct FVector& Location, const struct FVector& Rotation, const struct FVector& Scale, float FOV, float blendTime, class UObject* __WorldContext);
	void SetImageFromPath(class UImage* Image, const struct FString& IconPath, class UObject* __WorldContext);
	...
	void UpdateImageTint(class UImage* Image, const struct FLinearColor& Color, class UObject* __WorldContext);
	...
	void STATIC_IsLengthyScreen(class UObject* __WorldContext, bool* bWideScreen);
	...
	void STATIC_GetPlatfromDisplayName(const struct FString& strChannel, class UObject* __WorldContext, struct FString* showChannel);
	...
	void STATIC_GetLobbyFrameTexture(int frameLevel, class UObject* __WorldContext, class UTexture2D** Output);
	void STATIC_InvoleBpFunctionNoFetch(const struct FString& InName, const struct FString& InFunname, class UObject* __WorldContext);
	void CheckChatPrivacyAcceptStatus(class UObject* __WorldContext, bool* ChatPrivacyAcceptStatus);
	void GetGVoiceInterface(class UObject* __WorldContext, class UGVoiceInterface** outputObj);
	void STATIC_OpenUseItemUI(const struct FString& itemInsID, class UObject* __WorldContext);
	void STATIC_ConvertURLByLanguage(const struct FString& URL, class UObject* __WorldContext, struct FString* convertedURL);
	void STATIC_isChineseSymbol(const struct FString& Text, class UObject* __WorldContext, bool* Result);
	void STATIC_isSpace(const struct FString& Text, class UObject* __WorldContext, bool* Result);
	void STATIC_GetNationInfo(const struct FString& NationCode, class UObject* __WorldContext, struct FBP_STRUCT_RegionConfig_type* NationInfo);
	void STATIC_SetImageWithSpriteRes(const struct FString& ResPath, class UImage* Image, class UObject* __WorldContext);
	void STATIC_GetNationSwitch(const struct FString& Name, class UObject* __WorldContext, bool* Ret);
	void STATIC_GetBpLuaObject(const struct FString& bp_name, class UObject* __WorldContext, class ALuaClassObj** Lua_obj);
	void STATIC_CheckIfMenuOpen(int MenuId, class UObject* __WorldContext, bool* Ret);
	void STATIC_GetValidStringAll(const struct FString& Text, bool CanBeEnglish, bool CanBeNumber, bool CanBeWhiteSpace, bool CanBeChinese, bool CanBeSpace, bool CanBeChineseSymbol, class UObject* __WorldContext, struct FString* validText);
	void UpdateLobbyRedpointStatus(bool IsShow, int ModeID, class UObject* __WorldContext);
	void STATIC_GetItemTimeS_Server(int expire_ts, int valid_hours, class UObject* __WorldContext, struct FString* time_s, bool* is_have_limit);
	void STATIC_GetItemTimeS(int res_id, int FirstTimeNum, class UObject* __WorldContext, struct FString* time_s, bool* is_have_limit);
	void STATIC_TimeNumToTimeS(int time_num, class UObject* __WorldContext, struct FString* time_s);
	void STATIC_ShowItemTipsByButton(int ItemID, class UButton* Button, int validHours, bool isShowCloseBtn, class UObject* __WorldContext);
	...
	void STATIC_IsChinese(const struct FString& Text, class UObject* __WorldContext, bool* Result);
	void STATIC_SendBAReport(int ButtonType, int Reason, class UObject* __WorldContext);
