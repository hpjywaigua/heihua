...
enum class EPlayerStatisticalInfoForPCOB : uint8_t
{
	...
	EPlayerStatisticalInfoForPCOB__EPlayerStatisticalInfoForPCOB_MAX = 2
};
...
struct FRealtimeVerifyInfo
{
	...
	int                                                TimeAccTimes;                                             // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SpeedQuickCheck;                                          // 0x0064(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ShootVerifyClientHitAABBCount;                            // 0x0068(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ShootVerifyDSAABBMissCount;                               // 0x006C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PlayerZ;                                                  // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
