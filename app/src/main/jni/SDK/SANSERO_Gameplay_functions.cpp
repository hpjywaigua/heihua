...
// Function Gameplay.UAEPlayerController.RPC_Server_SyncClientPkgLossArrayInfo
// ()
// Parameters:
...
void AUAEPlayerController::RPC_Server_SyncClientPkgLossArrayInfo(TArray<unsigned char> InLoss, TArray<unsigned char> OutLoss)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Gameplay.UAEPlayerController.RPC_Server_SyncClientPkgLossArrayInfo");

	AUAEPlayerController_RPC_Server_SyncClientPkgLossArrayInfo_Params params;
...
int AUAEPlayerController::GenerateKillBroadcastItemID(int ClothAvatarID)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
