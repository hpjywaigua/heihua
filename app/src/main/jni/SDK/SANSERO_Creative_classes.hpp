...
public:
	...
	struct FTransform                                  GhostBuildingTransform;                                   // 0x11C0(0x0030) (IsPlainOldData)
	TArray<class AActor*>                              GetLocationActorsToIgnore;                                // 0x11F0(0x0010) (ZeroConstructor)
	float                                              LandOnOffsetZ;                                            // 0x1200(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              LandHitPointZ;                                            // 0x1204(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WaterHeight;                                              // 0x1208(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bForceLandOnGround;                                       // 0x120C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x120D(0x0003) MISSED OFFSET
	int                                                LandGroundType;                                           // 0x1210(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bSnapTransValid;                                          // 0x1214(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSnapGridEnable;                                          // 0x1215(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreLandOn;                                            // 0x1216(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xD];                                       // 0x1217(0x000D) MISSED OFFSET
	struct FRotator                                    ModifiedRotation;                                         // 0x1224(0x000C) (IsPlainOldData)
	struct FVector                                     ModifiedScale;                                            // 0x1230(0x000C) (IsPlainOldData)
	struct FRotator                                    RelativeRotation;                                         // 0x123C(0x000C) (IsPlainOldData)
	struct FVector                                     RelativeLocation;                                         // 0x1248(0x000C) (IsPlainOldData)
	struct FVector                                     RelativeScale;                                            // 0x1254(0x000C) (IsPlainOldData)
	struct FTransform                                  SnapBaseTransform;                                        // 0x1260(0x0030) (IsPlainOldData)
	bool                                               bOpenLandPosCheckDebug;                                   // 0x1290(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xF];                                       // 0x1291(0x000F) MISSED OFFSET
...
public:
	...
	ECreativeModeActorState                            ActorState;                                               // 0x04D8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x04D9(0x0007) MISSED OFFSET
	TArray<struct FCreativeEditorObjectEffectMesheInfo> CachedEffectMesheInfos;                                   // 0x04E0(0x0010) (ZeroConstructor)
	TMap<class UObject*, struct FCreativePoolObjectRecordInfo> PoolObjectRecordMap;                                      // 0x04F0(0x0050) (ZeroConstructor)
	int8_t                                             CanEditFlag;                                              // 0x0540(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0541(0x0007) MISSED OFFSET
	struct FEditorObjectLiteComponentTickFunction      LiteComponentActorTick;                                   // 0x0548(0x0058) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x05A0(0x0010) (ZeroConstructor, Transient)
...
public:
	...
	struct FGameStateLiteComponentTickFunction         LiteComponentActorTick;                                   // 0x1438(0x0058) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x1490(0x0010) (ZeroConstructor, Transient)
...
{
public:
	TMap<struct FString, class UCreativePhysicsComponent*> InstancePhysicsComponentMap;                              // 0x04C0(0x0050) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData00[0x68];                                      // 0x0510(0x0068) MISSED OFFSET
	int                                                RegisterMaxNum;                                           // 0x0578(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReplicateLimit;                                           // 0x057C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0008 (0x1A20 - 0x1A18)
class ACreativeModePlayerState : public ASTExtraPlayerState
{
public:
	bool                                               bEnableAutoPickUp;                                        // 0x1A18(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x1A19(0x0007) MISSED OFFSET
...
public:
	...
	unsigned char                                      bAsyncLoad : 1;                                           // 0x0940(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0941(0x000F) MISSED OFFSET
