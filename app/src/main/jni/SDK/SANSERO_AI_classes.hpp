...
{
public:
	unsigned char                                      bEnableTeamAI : 1;                                        // 0x0558(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0559(0x0007) MISSED OFFSET
	TArray<class UClass*>                              TeamAIClasses;                                            // 0x0560(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SpawnerCampItemID;                                        // 0x0570(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                SpawnerTeamID;                                            // 0x0574(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBotCategray>                          SpeciesCategory;                                          // 0x0578(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0579(0x0007) MISSED OFFSET
	TArray<class UActorComponent*>                     TeamAIComponents;                                         // 0x0580(0x0010) (ExportObject, ZeroConstructor)
...
public:
	...
	struct FVehicleParams                              CacheVehicleParams;                                       // 0x01A4(0x0014)
...
public:
	...
	int                                                NearbyVehicleRange;                                       // 0x0270(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	...
	struct FAIStateInfo                                CacheAIStateInfo;                                         // 0x0288(0x05A8)
	struct FDiffAIStateInfo                            CacheDiffAIStateInfo;                                     // 0x0830(0x04E8)
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0D18(0x0040)
	float                                              AirAttackTotalTime;                                       // 0x0D58(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsTouchedPlayer;                                          // 0x0D5C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreTreeAIWhenNoPlayerAround;                          // 0x0D5D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0D5E(0x0002) MISSED OFFSET
	float                                              IgnoreTreeAIRadius;                                       // 0x0D60(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	uint32_t                                           FrameNo;                                                  // 0x0D64(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsCacheDiffData;                                          // 0x0D68(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               UseBodyTPPCamera;                                         // 0x0D69(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x0D6A(0x0006) MISSED OFFSET
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x0D70(0x0008) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x0D78(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x0D80(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x0D88(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x0D90(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x0D98(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x0DA0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x80];                                      // 0x0DA8(0x0080) MISSED OFFSET
	TArray<struct FVehicleDamageInfo>                  VehicleDamageInfo;                                        // 0x0E28(0x0010) (ZeroConstructor)
	TMap<int, class APickUpWrapperActor*>              CacheAINearByItem;                                        // 0x0E38(0x0050) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x0E88(0x0020)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x0EA8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x0EB0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x0EB4(0x000C) MISSED OFFSET
...
public:
	...
	TMap<uint32_t, bool>                               DeadTeammatePlayerStateSendIDs;                           // 0x03E8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIStateInfo>                CacheTeammatePlayerStateInfos;                            // 0x0438(0x0050) (ZeroConstructor)
	TMap<uint32_t, uint32_t>                           CacheDiffTeammatePlayerStateKeys;                         // 0x0488(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               TeammatePlayerDiffChecks;                                 // 0x04D8(0x0050) (ZeroConstructor)
	TArray<struct FString>                             TeammateStateWhiteList;                                   // 0x0528(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x50];                                      // 0x0538(0x0050) MISSED OFFSET
	TMap<uint32_t, struct FAIStateInfo>                CacheAllPlayerInfo;                                       // 0x0588(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x10];                                      // 0x05D8(0x0010) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x05E8(0x0050) (ZeroConstructor)
