...
{
public:
	unsigned char                                      UnknownData00[0x198];                                     // 0x0110(0x0198) MISSED OFFSET
	...
	unsigned char                                      UnknownData01[0x74];                                      // 0x02BC(0x0074) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x50];                                      // 0x0448(0x0050) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x10F];                                     // 0x04F9(0x010F) MISSED OFFSET
	TArray<struct FModAttrSimulateSyncItem>            ModSimulateSyncList;                                      // 0x0608(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData05[0x108];                                     // 0x0618(0x0108) MISSED OFFSET
...
// 0x0340 (0x35718 - 0x353D8)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0xD4];                                      // 0x353D8(0x00D4) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x354AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x354B0(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x354B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x354B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x354BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x354C0(0x0050) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x35510(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x35511(0x0007) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x35518(0x0010) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x35528(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x3552C(0x000C) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x35538(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x3553C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x35540(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x35544(0x0004) MISSED OFFSET
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x35548(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x35598(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x100];                                     // 0x355A0(0x0100) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x356A0(0x0010) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x356B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x356B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0xC];                                       // 0x356B8(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x356C4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x356C5(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x356C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x356CC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x356D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x356D4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x356D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x15];                                      // 0x356DC(0x0015) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x356F1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x12];                                      // 0x356F2(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x35704(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x10];                                      // 0x35708(0x0010) MISSED OFFSET
...
{
public:
	struct FScriptDelegate                             OnMemWarning;                                             // 0x0028(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     TableRelativeDir;                                         // 0x0038(0x0010) (ZeroConstructor, Config)
	TArray<struct FName>                               TablesNeedReleasedInBattle;                               // 0x0048(0x0010) (ZeroConstructor, Config)
	struct FString                                     ManualTableDirectory;                                     // 0x0058(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData00[0x100];                                     // 0x0068(0x0100) MISSED OFFSET
	bool                                               AllowItemTable;                                           // 0x0168(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0169(0x0007) MISSED OFFSET
	TArray<class UUAEDataTable*>                       TableObjList;                                             // 0x0170(0x0010) (ZeroConstructor)
	class UWorld*                                      CurWorld;                                                 // 0x0180(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> TableObjMap;                                              // 0x0188(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> TableObjMap_Mod;                                          // 0x01D8(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnTableCreateInFighting;                                  // 0x0228(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x118];                                     // 0x0238(0x0118) MISSED OFFSET
	struct FString                                     PathCompressionConfigsPath;                               // 0x0350(0x0010) (ZeroConstructor, Config)
	bool                                               bIsPathCompression;                                       // 0x0360(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsPathCompressionCache;                                  // 0x0361(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0362(0x0002) MISSED OFFSET
	int                                                PathCompressionCacheMaxSize;                              // 0x0364(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bTranslationFallBackUnloadDuplicate;                      // 0x0368(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bShrinkTranslationMap;                                    // 0x0369(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xE];                                       // 0x036A(0x000E) MISSED OFFSET
	struct FString                                     BaseTableRelativeDir;                                     // 0x0378(0x0010) (ZeroConstructor, Config)
	struct FString                                     ModTableRelativeDir;                                      // 0x0388(0x0010) (ZeroConstructor, Config)
	...
	void TriggerReleaseTable();
	void ReleaseTable(const struct FName& TableFName);
	void RegisterMemWarningEvent();
	void LuaReleaseAllTable();
