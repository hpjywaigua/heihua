...
// (NetReliable, Event, NetMulticast, MulticastDelegate, Public, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent, Const, NetValidate)
// Parameters:
...
// (NetReliable, Exec, Event, NetMulticast, MulticastDelegate, Public, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent, Const, NetValidate)
// Parameters:
// class UUserWidget**            Widget                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
// (Event, NetMulticast, MulticastDelegate, Public, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent, Const, NetValidate)
// Parameters:
// class UUserWidget**            Widget                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Native, NetMulticast, Public, Private, Protected, Delegate, NetServer, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, Const, NetValidate)
// Parameters:
