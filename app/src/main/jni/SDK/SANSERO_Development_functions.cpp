...
// Function Development.GMCheatManager.StartAPMTag
// ()
// Parameters:
// struct FString                 TagName                        (Parm, ZeroConstructor)

void UGMCheatManager::StartAPMTag(const struct FString& TagName)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Development.GMCheatManager.StartAPMTag");

	UGMCheatManager_StartAPMTag_Params params;
...
void UGMCheatManager::GMSpawnSocialLandPlayerAIAroundPointWithAvatarList(uint32_t DataOffset, uint32_t AINum, float X, float Y, float Z, float fRadius, bool bActiveAI, bool IsAIInvincible, bool bWithPet, bool bWithEqui, struct FString* AvatarList)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UGMCheatManager::GMSpawnSocialLandPlayerAIAroundMeWithAvatar(uint32_t AINum, float fRadius, bool bActiveAI, bool IsAIInvincible, bool bWithPet, bool bWithEqui, struct FString* AvatarList)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
