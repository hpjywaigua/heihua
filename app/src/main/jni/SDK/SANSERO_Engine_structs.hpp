...
struct FDSPVSParameter
{
	...
	float                                              CellSizeXYInCentimeterWhenCoverWholeMap;                  // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EDSPVSConfigCategory>                  DSVisibilityAggressiveness;                               // 0x000C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
