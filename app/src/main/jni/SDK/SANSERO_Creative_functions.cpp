...
// Function Creative.CreativeAbilitySystemComponent.GetSnappedLocAxisUnit
// ()
// Parameters:
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

float UCreativeAbilitySystemComponent::GetSnappedLocAxisUnit()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeAbilitySystemComponent.GetSnappedLocAxisUnit");

	UCreativeAbilitySystemComponent_GetSnappedLocAxisUnit_Params params;
...
// Function Creative.CreativeInstanceManager.SetInstanceTransform
// ()
// Parameters:
// struct FString                 InstanceID                     (Parm, ZeroConstructor)
// struct FTransform              Transform                      (Parm, IsPlainOldData)

void UCreativeInstanceManager::SetInstanceTransform(const struct FString& InstanceID, const struct FTransform& Transform)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeInstanceManager.SetInstanceTransform");

	UCreativeInstanceManager_SetInstanceTransform_Params params;
	params.InstanceID = InstanceID;
