...
{
	struct FUnitConfig                                 UnitConfig;                                               // 0x0000(0x0058) (BlueprintVisible)
	struct FVector                                     SpawnLocation;                                            // 0x0058(0x000C) (BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData00[0xC];                                       // 0x0064(0x000C) MISSED OFFSET
	struct FTransform                                  Transform;                                                // 0x0070(0x0030) (BlueprintVisible, IsPlainOldData)
	int                                                AttributeID;                                              // 0x00A0(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	uint32_t                                           SpawnerID;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FUnitRatio
{
	struct FUnitConfig                                 Unit;                                                     // 0x0000(0x0058) (Edit)
	float                                              Ratio;                                                    // 0x0058(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
