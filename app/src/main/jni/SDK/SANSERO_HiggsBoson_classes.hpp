...
public:
	...
	unsigned char                                      UnknownData01[0xA0F];                                     // 0x0041(0x0A0F) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData06[0x768];                                     // 0x03D8(0x0768) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0B40(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x68];                                      // 0x0B48(0x0068) MISSED OFFSET
	bool                                               bMHActive;                                                // 0x0BB0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x5F];                                      // 0x0BB1(0x005F) MISSED OFFSET
	TMap<int, int>                                     FFItemIDMap;                                              // 0x0C10(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x84];                                      // 0x0C60(0x0084) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0CE4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0CE8(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0CEC(0x0004) (ZeroConstructor, IsPlainOldData)
